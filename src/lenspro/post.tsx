...
import { getAddressFromSigner, signedTypeData, splitSignature,getSigner } from './ethers-service';
...
export const createPost = async (pid:string,contentURI:string,collecModule:string) => {
  const profileId = pid;
