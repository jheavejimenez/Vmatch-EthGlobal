...
const navigation = [
  ...
  { name: 'Explore', icon: GlobeAltIcon, href: 'test', current: false },
  { name: 'Messages', icon: InboxIcon, href: '#', current: false },
  // { name: 'Matches', icon: ChartBarIcon, href: '#', count: 12, current: false },
]
  ...
  return (
    <div className="flex h-screen min-h-0 flex-1 flex-col bg-gray-800">
      <div className="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
        ...
        <nav
          className="mt-16 flex-1 space-y-1 bg-gray-800 px-2"
          aria-label="Sidebar"
        >
          {navigation.map((item) => (
            <a
